...
public class APDTImages {
	...
	public static final ImageDescriptor DESC_EXPORT = create(PATH_ETOOLS16,
			"apd-export.gif"); //$NON-NLS-1$
	public static final ImageDescriptor DESC_SNIPPET_EXPORT = create(
			PATH_WIZBAN, "snippet_export_wiz.gif"); //$NON-NLS-1$
	public static final ImageDescriptor DESC_SNIPPET_IMPORT = create(
			PATH_WIZBAN, "snippet_import_wiz.gif"); //$NON-NLS-1$
	public static final ImageDescriptor DESC_IMPORT = create(PATH_ETOOLS16,
			"apd-import.gif"); //$NON-NLS-1$
