...
/**
 * Entry point of the 'JSGenerator' generation module.
 * 
 */
public class JSGenerator extends AbstractAcceleoGenerator {
	/**
	 * The name of the module.
	 * 
	 */
	public static final String MODULE_FILE_NAME = "JSGenerator";
	...
	public JSGenerator(EObject model, File dir,String name,String format ) throws IOException {
		initialize(model, dir, Arrays.asList(name,format));
