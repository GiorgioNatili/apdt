...
/**
 * Entry point of the 'PHPGenerator' generation module.
 * 
 */
public class PHPGenerator extends AbstractAcceleoGenerator {
	/**
	 * The name of the module.
	 * 
	 */
	public static final String MODULE_FILE_NAME = "PHPGenerator";
	...
	public PHPGenerator(EObject model, File dir) throws IOException {
